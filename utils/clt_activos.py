...
querys_ctls_activos = {
   ...
   WITH CLT_ACT_X_CONTRATO AS (
    	...
    	SELECT CAF2.NUMERO_CONTRATO, CAF2.NUMERO_PRESTAMO, CAF2.FECHA_APERTURA, CAF2.FECHA_VENCIMIENTO, MG.*
    	FROM CLTS_ACTIVOS_FILTRO_2 CAF2
    	INNER JOIN SIRAC.MG_CLIENTES MG ON MG.CODIGO_CLIENTE = CAF2.CODIGO_CLIENTE
   	 	) , CLT_INFO_P AS (
