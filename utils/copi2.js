...
import {toggleSidebar,  toggleDropdown, formatLargeNumber, toggleSubfiltro, aplicarFiltros, toggleDropdown2} from './utils.js';
...
document.addEventListener('click', function (e) {
  if (!dropdownContainer.contains(e.target) && e.target !== inputSearch) {
    ...
    function initializeProductos(){
        ...
        // Cargar automáticamente la subpágina inicial (siag.html)
        loadSubPage("pages/subpages/sims.html");
        
        //  Pestaña
        let tabElement = document.getElementById("nav-sims-tab");

        if (tabElement) {
            new bootstrap.Tab(tabElement).show();
        }

        // Asignar eventosde clic a los enlaces dentro de "nav-tab_sistemas"
        links.forEach(link => {
    ...
    function initializeProductMeca(){
        ...
        .then(data => {
            ...
            //createBarChartV2('',null, null, dataMontosAnual, {}, 'Transacciones', 'transacciones')
        ...
        .then(data => {
            ...
            function createBestAgentsComponent(containerId, data, periods) {
                ...
                function renderComponent() {
                  ...
                  container.innerHTML = `
                    <div class="w-full pt-0 pl-8 pr-8 rounded-lg shadow-md""> 
                  ...
                  return `
                    <li class="flex items-center justify-between border-b pb-2 last:border-b-0">
                      ...
                      <div class="text-right">
                        <p class="text-sm text-[#1d58d8] font-medium">${agent.transacciones} transacciones en el año</p>
                    ...
                    return `
                      <div class="relative inline-block text-left">
                        ...
                        <div id="${containerId}-dropdown-menu"
                          class="absolute hidden bg-white shadow-xl rounded-lg py-2 w-52 text-gray-700 text-sm font-medium z-20 transition-all duration-200 transform opacity-0 scale-95 
                  ...
                  return `
                    <li class="flex items-center justify-between border-b pb-2 last:border-b-0">
                      ...
                      <div class="text-right">
                        ...
                        <p class="text-sm text-gray-600  font-medium">${agent.transacciones} transacciones</p>
                      </div>
                    </li>
                  `;
                }
